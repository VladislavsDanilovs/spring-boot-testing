...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setFirstname("Bubba");
        student.setLastname("Bumblebee");
        student.setEmailAddress("bubba.bumblebee@gmail.com");
    ...
    public void isGradeGreaterStudentGrades() {
        assertTrue(studentGrades.isGradeGreater(90, 75), "a > b - should be true");
    }

    @DisplayName("Is grade greater false ")
    @Test
    public void isGradeGreaterStudentGradesAssertFalse() {
        assertFalse(studentGrades.isGradeGreater(89, 90), "failure - should be true");
    }

    @DisplayName("Check Not Null for student grades ")
    @Test
    public void checkNotNullForStudentGrades() {
        assertNotNull(studentGrades.checkNull(student.getStudentGrades().getMathGradeResults()),
                "Student grade should be not null");
    }
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setLastname("Danilov");
        studentTwo.setEmailAddress("vlad.danilov@gmail.com");
