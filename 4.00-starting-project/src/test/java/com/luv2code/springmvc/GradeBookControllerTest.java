...
@SpringBootTest
@Transactional // for JPA Entity manager in this test
public class GradeBookControllerTest {
    ...
    @Autowired
    ObjectMapper objectMapper; // for REST API tests
    ...
    public static void setup() {
        ...
        request.setParameter("emailAddress", "vlad.danilov@gmail.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        entityManager.flush(); /* will force the data to be persist in the database immediately as EntityManager.persist() will not (depending on how the EntityManager is configured */
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        student.setLastname("Bread");
        student.setEmailAddress("maxim.bread@gmail.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("maxim.bread@gmail.com");
        assertNotNull(verifyStudent, "should be valid");
    }
